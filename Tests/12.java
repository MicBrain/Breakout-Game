...
public class SList {
  ...
  public void squish() {
    ...
    SListNode tracker = head;
    if (tracker == null) {
      return;
    }
    while (tracker.next!=null) {
      if (tracker.item.equals(tracker.next.item)) {
  ...
  public void twin() {
    ...
    SListNode trackerrr = head;
    if (trackerrr==null) {
      return;
    }
    while (trackerrr != null) {
      SListNode newNode = new SListNode(trackerrr.item, trackerrr.next);
      trackerrr.next = newNode;
      trackerrr = trackerrr.next.next;
      }
  }
